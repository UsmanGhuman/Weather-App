...
//This function gives hunidity value and return humidity levels
...
//This function nconverts meters to kilometrs
export const getVisibilityValue = (visibility) => {
    const km = visibility / 1000;
    return `${km.toFixed(1)} km`;
};

//This converts celcius to farhenheit upto1 decimal place
