...
export default function App() {
  ...
  const API_KEY = 'a890851ad0c9ec9571c5d841e7f75928'
  ...
  //Fetches 5 locations suggestions from API and Updtaes
...
`
  ...
  //this function checks weather exists and return an object
      ...
      </h1>
      {
        !weather ? (
          <form onSubmit={handleSearch} className='flex flex-col relative'>
            <input value={city} onChange={(e) => setCity(e.target.value)} placeholder='Enter city or Country(min three letters)' className='mb-4 p-3 rounded border border-white bg-transparent text-white placeholder-white focus:outline-none focus:border-blue-300 transition duration-300'/>
            {suggestion.length > 0 && (
            ...
            <button type='submit' className='bg-purple-700 hover:bg-blue-700 text-white font-semibold p-2 px-4 rouned transition-colors'>
              Get Weather
            </button>
          </form>
        ) : (
          <div className='mt-6 text-center transition-opacity duration-500'>
            <button onClick={() => {setWeather(null); setCity('')}}
              className='mb-4 bg-purple-900 hover:bg-blue-700 text-white font-medium font-semiboldpy-1 px-3 rounded transition-colors'>
                New Search
            </button>
            ...
            <div className='flex flex-wrap justify-around mt-6'>
              {[
                ...
                [VisibilityIcon, 'Visibility', getVisibilityValue(weather.visibilty)]
